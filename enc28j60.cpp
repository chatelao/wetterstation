...
byte ENC28J60::initialize (word size, const byte* macaddr, byte csPin) {
    Serial.println( "Dbg-initialize-0");
    bufferSize = size;
    ...
    Serial.println( "Dbg-initialize-1");
    writeOp(ENC28J60_SOFT_RESET, 0, ENC28J60_SOFT_RESET);
    Serial.println( "Dbg-initialize-1a");
    delay(8); // errata B7/2
    while (!readOp(ENC28J60_READ_CTRL_REG, ESTAT) & ESTAT_CLKRDY)
      // ;
      Serial.println( "Dbg-initialize-1b");
        
    Serial.println( "Dbg-initialize-2");
    ...
    Serial.println( "Dbg-initialize-3");
    ...
    Serial.println( "Dbg-initialize-4");
